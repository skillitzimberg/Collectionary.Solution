...
The project files generated will have starter content as outlined in the Epicodus C Sharp course. The template will give relevant namespaces and paths for your project (i.e. Collectionary will be replaced everywhere with the name you give to your project - YourProjectName).

The directory/file structure created is:

```
Collectionary.Solution
├── Collectionary
│   ├── Controllers
│   │   ├── HomeController.cs
│   │   └── ClassController.cs
...
Clone the code from [GitHub](https://github.com/skillitzimberg/Collectionary.Solution).
...
* dotnet new --install [ /Users/Your/Path/Here ]/Collectionary.Solution

For example: When cloned to the Epicodus computer Desktop, the path would be /Users/Guest/Desktop/Collectionary.Solution.
The above command would then be:
* dotnet new --install /Users/Guest/Desktop/Collectionary.Solution
...
* dotnet new collectionary -n [ YourProjectName ] -o [ YourProjectName ].Solution

For example: If your project is called Banana the command would be:
* dotnet new collectionary -n Banana -o Banana.Solution
